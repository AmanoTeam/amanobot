...
class Bot(_BotBase):
    ...
    async def createChatInviteLink(self, chat_id,
    ...
    async def editChatInviteLink(self, chat_id,
                                 invite_link: str,
                                 expire_date: int = None,
                                 member_limit: int = None):
    ...
    async def revokeChatInviteLink(self, chat_id, invite_link: str):
    ...
    async def editMessageMedia(self, msg_identifier, media,
                               reply_markup=None):
        """
    ...
    async def deleteMessage(self, msg_identifier):
        ...
        :param msg_identifier:
            Same as ``msg_identifier`` in :meth:`amanobot.aio.Bot.editMessageText`,
