...
import random
import amanobot.aio
from amanobot.aio.routing import (by_content_type, make_content_type_routing_table,
...
top_router = amanobot.aio.helper.Router(random_key, {0: zero,
                                                      1: one,
                                                      2: two,
                                                      3: three,
                                                      (None,): none_tuple,
...
command_router = amanobot.aio.helper.Router(lower_key(by_chat_command()),
...
regex_router = amanobot.aio.helper.Router(by_regex(lambda msg: msg['text'], '(CS[0-9]{3})'),
